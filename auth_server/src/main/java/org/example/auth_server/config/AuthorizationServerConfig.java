...
public class AuthorizationServerConfig {
    ...
    public SecurityFilterChain buildFilterChain(HttpSecurity security) throws Exception {
    ...
    @Bean
    public RegisteredClientRepository registerClients(PasswordEncoder passwordEncoder) {
        // Параметры, которые надо бы определять в application.properties
